...
// dummy
MACRO_CONFIG_STR(DummyName, dummy_name, 16, "a dummy", CFGFLAG_SAVE | CFGFLAG_CLIENT, "Name of the Dummy")
...
MACRO_CONFIG_INT(UiMousesens, ui_mousesens, 100, 1, 100000, CFGFLAG_SAVE|CFGFLAG_CLIENT, "Mouse sensitivity for menus")
...
MACRO_CONFIG_INT(UiWideview, ui_wideview, 1, 0, 1, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Extended menus GUI")
...
MACRO_CONFIG_INT(ClStatboardInfos, cl_statboard_infos, 1771, 1, 2047, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Mask of infos to display on the global statboard")
